  ...
  <section id="container">
                ...
                <div class="form-group">
                  ...
                  <div class="controls col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      ...
                      <a href="advanced_form_components.php#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none; margin-left:5px;"></a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      ...
                      <div>
                        ...
                        <a href="advanced_form_components.php#" class="btn btn-theme04 fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> Remove</a>
                      </div>
                    </div>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="advanced_form_components.php#" class="go-top">
